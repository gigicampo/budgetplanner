const CACHE="budget-planner-v19";
const APP_PAGE="./index.html";
const CORE=["./",APP_PAGE,"./user-guide.html","./manifest.webmanifest","./Budget-Planner-App-Icon.svg","./Budget-Planner-App-Icon-192.png","./Budget-Planner-App-Icon-512.png","./jszip.min.js","./currency.js","./analytics-workbook.js","./sync-safety.js","./analytics-template.xlsx"];
